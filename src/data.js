...
export const PROVIDERS = [
  { id: "samsung-mc", name: { en: "Samsung Medical Center", ko: "삼성서울병원" }, image: "https://images.unsplash.com/photo-1581595219315-a187dd40c322?w=1000&q=80", area: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, rating: 4.9, reviews: 1482, accreditation: ["JCI", "ISO 9001", "KAHF"], departments: ["general", "screen", "derm", "ophth", "plastic", "dental", "obgyn", "ortho", "urology"], languages: ["en", "zh", "ru"], english_support: true, international_ward: true,
    ...
    // 의료진 — 어드민(콘텐츠 관리 · 파트너 병원 > 항목 편집 > Doctors)에서 사진/이름/전공/약력 입력·수정
    doctors: [
      { name: { en: "Prof. Woo-sung Jung", ko: "정우성 교수" }, title: { en: "Medical Oncology", ko: "종양내과" }, credentials: { en: "MD, PhD · 25 yrs", ko: "MD, PhD · 25년" }, photo: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&q=80" },
      { name: { en: "Dr. Ji-min Han", ko: "한지민 과장" }, title: { en: "Cardiothoracic Surgery", ko: "심장혈관흉부외과" }, credentials: { en: "MD · 20 yrs", ko: "MD · 20년" }, photo: "https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=400&q=80" },
      { name: { en: "Dr. Seo-jun Park", ko: "박서준 과장" }, title: { en: "Gastroenterology", ko: "소화기내과" }, credentials: { en: "MD, PhD · 18 yrs", ko: "MD, PhD · 18년" }, photo: "https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=400&q=80" },
...
export const PROCEDURES = [
  {
    ...
    options: [{ group: { en: "Add-on examination", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Dry-eye screening", "Corneal topography"], ko: ["안구건조 검사", "각막 지형도 검사"] } }],
  ...
  },
  {
    ...
    options: [{ group: { en: "Add-on", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["PET-CT", "Cardiac MRI"], ko: ["PET-CT", "심장 MRI"] } }],
  ...
  {
    id: "lasek-correction", category: "ophthalmology", dept: { en: "Ophthalmology", ko: "안과" }, recoveryBand: "lt1w",
    hospital: { id: "gangnam-bright-eye", name: { en: "Gangnam Seoul Bright Eye Clinic", ko: "강남서울밝은안과" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=1000&q=80" },
    name: { en: "LASEK", ko: "라섹(LASEK)" },
    hero: "https://images.unsplash.com/photo-1577003833619-76bbd7f82948?w=1200&q=80", before: "https://images.unsplash.com/photo-1645066928295-2506defde470?w=600&q=80", after: "https://images.unsplash.com/photo-1642975967602-653d378f3b5b?w=600&q=80",
    summary: { en: "Surface-based vision correction suitable even for thin corneas.", ko: "각막 표면을 다듬는 시력교정 — 얇은 각막에도 적합." },
    duration: { en: "1–2 days in Korea", ko: "한국 체류 1–2일" }, recovery: { en: "48h recovery", ko: "48시간 회복" },
    includes: { en: ["Detailed pre-op eye exam","Procedure (both eyes)","Protective eyewear kit","Next-day check-up"], ko: ["수술 전 정밀 검사","시술(양안)","보호 안경 키트","익일 경과 검진"] },
    options: [{ group: { en: "Add-on examination", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Dry-eye screening","Corneal topography"], ko: ["안구건조 검사","각막 지형도 검사"] } }],
    steps: { en: ["Detailed pre-op exam","Surgeon consultation","Procedure","Same-day discharge","Next-day check-up"], ko: ["정밀 사전 검사","집도의 상담","시술","당일 퇴원","익일 경과 검진"] },
    prepare: { en: ["Stop wearing contact lenses 1 week prior","Arrange someone to accompany you home"], ko: ["1주 전부터 콘택트렌즈 착용 중단","귀가 시 동반자 준비"] },
    listPrice: 1800000, price: 1500000,
  },
  {
    id: "presbyopia-lens", category: "ophthalmology", dept: { en: "Ophthalmology", ko: "안과" }, recoveryBand: "lt1w",
    hospital: { id: "gangnam-bright-eye", name: { en: "Gangnam Seoul Bright Eye Clinic", ko: "강남서울밝은안과" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=1000&q=80" },
    name: { en: "Presbyopia & Cataract Lens", ko: "노안·백내장 교정" },
    hero: "https://images.unsplash.com/photo-1577003833619-76bbd7f82948?w=1200&q=80", before: "https://images.unsplash.com/photo-1645066928295-2506defde470?w=600&q=80", after: "https://images.unsplash.com/photo-1642975967602-653d378f3b5b?w=600&q=80",
    summary: { en: "Multifocal IOL correcting presbyopia and cataract together.", ko: "다초점 인공수정체로 노안과 백내장을 함께 교정." },
    duration: { en: "1–2 days in Korea", ko: "한국 체류 1–2일" }, recovery: { en: "48h recovery", ko: "48시간 회복" },
    includes: { en: ["Detailed pre-op eye exam","Procedure (both eyes)","Protective eyewear kit","Next-day check-up"], ko: ["수술 전 정밀 검사","시술(양안)","보호 안경 키트","익일 경과 검진"] },
    options: [{ group: { en: "Add-on examination", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Dry-eye screening","Corneal topography"], ko: ["안구건조 검사","각막 지형도 검사"] } }],
    steps: { en: ["Detailed pre-op exam","Surgeon consultation","Procedure","Same-day discharge","Next-day check-up"], ko: ["정밀 사전 검사","집도의 상담","시술","당일 퇴원","익일 경과 검진"] },
    prepare: { en: ["Stop wearing contact lenses 1 week prior","Arrange someone to accompany you home"], ko: ["1주 전부터 콘택트렌즈 착용 중단","귀가 시 동반자 준비"] },
    listPrice: 4200000, price: 3500000,
  },
  {
    id: "dental-veneer", category: "dental", dept: { en: "Dental", ko: "치과" }, recoveryBand: "1m",
    hospital: { id: "apgujeong-dental", name: { en: "Apgujeong Premium Dental", ko: "압구정 프리미엄 치과" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?w=1000&q=80" },
    name: { en: "Ceramic Veneer", ko: "세라믹 라미네이트" },
    hero: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=1200&q=80", before: "https://images.unsplash.com/photo-1609840114035-3c981b782dfe?w=600&q=80", after: "https://images.unsplash.com/photo-1581585095544-bb2c8a4d3a3e?w=600&q=80",
    summary: { en: "Premium ceramic veneers with minimal tooth reduction.", ko: "치아 삭제를 최소화한 프리미엄 세라믹 라미네이트." },
    duration: { en: "2 visits over 3 months", ko: "3개월간 2회 방문" }, recovery: { en: "About 1 month", ko: "약 1개월" },
    includes: { en: ["3D CT imaging & planning","Procedure","Crown / prosthesis","Post-care scaling"], ko: ["3D CT 촬영·계획","시술","크라운·보철","사후 스케일링"] },
    options: [{ group: { en: "Material", ko: "재질" }, multi: false, pick: 1, items: { en: ["Zirconia","Gold"], ko: ["지르코니아","골드"] } }],
    steps: { en: ["Diagnosis & imaging","Consultation","Procedure","Post-care follow-up"], ko: ["진단·촬영","상담","시술","사후 관리"] },
    prepare: { en: ["Bring previous dental records if available"], ko: ["기존 치과 진료 기록 지참(있을 경우)"] },
    listPrice: 1300000, price: 1000000,
  },
  {
    id: "clear-aligner", category: "dental", dept: { en: "Dental", ko: "치과" }, recoveryBand: "1m",
    hospital: { id: "apgujeong-dental", name: { en: "Apgujeong Premium Dental", ko: "압구정 프리미엄 치과" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?w=1000&q=80" },
    name: { en: "Clear Aligner", ko: "투명교정" },
    hero: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=1200&q=80", before: "https://images.unsplash.com/photo-1609840114035-3c981b782dfe?w=600&q=80", after: "https://images.unsplash.com/photo-1581585095544-bb2c8a4d3a3e?w=600&q=80",
    summary: { en: "Discreet clear aligners for tooth alignment.", ko: "눈에 띄지 않는 투명 장치로 치아 배열 교정." },
    duration: { en: "2 visits over 3 months", ko: "3개월간 2회 방문" }, recovery: { en: "About 1 month", ko: "약 1개월" },
    includes: { en: ["3D CT imaging & planning","Procedure","Crown / prosthesis","Post-care scaling"], ko: ["3D CT 촬영·계획","시술","크라운·보철","사후 스케일링"] },
    options: [{ group: { en: "Material", ko: "재질" }, multi: false, pick: 1, items: { en: ["Zirconia","Gold"], ko: ["지르코니아","골드"] } }],
    steps: { en: ["Diagnosis & imaging","Consultation","Procedure","Post-care follow-up"], ko: ["진단·촬영","상담","시술","사후 관리"] },
    prepare: { en: ["Bring previous dental records if available"], ko: ["기존 치과 진료 기록 지참(있을 경우)"] },
    listPrice: 6000000, price: 4800000,
  },
  {
    id: "lifting-laser", category: "dermatology", dept: { en: "Dermatology", ko: "피부과" }, recoveryBand: "lt1w",
    hospital: { id: "cheongdam-glow-derm", name: { en: "Cheongdam Glow Dermatology", ko: "청담 글로우 피부과" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1612908689435-744b8b0a0c46?w=1000&q=80" },
    name: { en: "Lifting Laser", ko: "리프팅 레이저" },
    hero: "https://images.unsplash.com/photo-1612908689435-744b8b0a0c46?w=1200&q=80", before: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=600&q=80", after: "https://images.unsplash.com/photo-1516549655169-df83a0774514?w=600&q=80",
    summary: { en: "Ultrasound lifting for firmness and wrinkles.", ko: "초음파 리프팅으로 탄력·주름을 개선." },
    duration: { en: "Per session", ko: "회당" }, recovery: { en: "Same day", ko: "당일" },
    includes: { en: ["Skin analysis","Laser/treatment session","Soothing care","After-care kit"], ko: ["피부 분석","레이저·시술","진정 케어","사후 케어 키트"] },
    options: [{ group: { en: "Add-on care", ko: "추가 케어" }, multi: true, pick: 1, items: { en: ["LDM soothing","Regeneration ampoule"], ko: ["LDM 진정","재생 앰플"] } }],
    steps: { en: ["Skin analysis","Consultation","Treatment session","Soothing care"], ko: ["피부 분석","상담","시술","진정 케어"] },
    prepare: { en: ["Remove makeup before the session"], ko: ["시술 전 메이크업 제거"] },
    listPrice: 2400000, price: 1900000,
  },
  {
    id: "pigment-care", category: "dermatology", dept: { en: "Dermatology", ko: "피부과" }, recoveryBand: "lt1w",
    hospital: { id: "cheongdam-glow-derm", name: { en: "Cheongdam Glow Dermatology", ko: "청담 글로우 피부과" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1612908689435-744b8b0a0c46?w=1000&q=80" },
    name: { en: "Pigment & Brightening", ko: "색소·미백 케어" },
    hero: "https://images.unsplash.com/photo-1612908689435-744b8b0a0c46?w=1200&q=80", before: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=600&q=80", after: "https://images.unsplash.com/photo-1516549655169-df83a0774514?w=600&q=80",
    summary: { en: "Toning laser program for pigment and blemishes.", ko: "기미·잡티·색소를 개선하는 토닝 레이저 프로그램." },
    duration: { en: "Per session", ko: "회당" }, recovery: { en: "Same day", ko: "당일" },
    includes: { en: ["Skin analysis","Laser/treatment session","Soothing care","After-care kit"], ko: ["피부 분석","레이저·시술","진정 케어","사후 케어 키트"] },
    options: [{ group: { en: "Add-on care", ko: "추가 케어" }, multi: true, pick: 1, items: { en: ["LDM soothing","Regeneration ampoule"], ko: ["LDM 진정","재생 앰플"] } }],
    steps: { en: ["Skin analysis","Consultation","Treatment session","Soothing care"], ko: ["피부 분석","상담","시술","진정 케어"] },
  ...
  {
    id: "cancer-screening", category: "checkup", dept: { en: "Health Check-up", ko: "건강검진" }, recoveryBand: "lt1w",
    hospital: { id: "seoul-premier-checkup", name: { en: "Seoul Premier Health Center", ko: "서울 프리미어 검진센터" }, city: { en: "Jongno-gu, Seoul", ko: "서울 종로구" }, square: "https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=1000&q=80" },
    name: { en: "Cancer Screening", ko: "암 정밀 검진" },
    hero: "https://images.unsplash.com/photo-1581595219315-a187dd40c322?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&q=80",
    summary: { en: "Precision package centered on cancer markers and imaging.", ko: "주요 암 표지자·영상 중심 정밀 검진 패키지." },
    duration: { en: "Half-day", ko: "반나절" }, recovery: { en: "Same day", ko: "당일" },
    includes: { en: ["Consultation & basic measurements","Blood & urine panel","Imaging (ultrasound/CT)","Specialist result review"], ko: ["문진·기본 신체 계측","혈액·소변 정밀 검사","영상 검사(초음파/CT)","전문의 결과 상담"] },
    options: [{ group: { en: "Add-on tests", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Cardiac CT","Endoscopy (gastro/colon)","Tumor markers"], ko: ["심장 CT","위·대장 내시경","종양표지자 검사"] } }],
    steps: { en: ["Check-in & intake","Screening tests","Radiology reading","Result consultation"], ko: ["접수·문진","검사 진행","영상 판독","결과 상담"] },
    prepare: { en: ["Fast for 8 hours before the exam","Wear comfortable clothing"], ko: ["검사 전 8시간 금식","편안한 복장 착용"] },
    listPrice: 2600000, price: 2100000,
  },
  {
    id: "scalp-smp", category: "hair-loss", dept: { en: "Hair Restoration", ko: "모발이식" }, recoveryBand: "1m",
    hospital: { id: "seoul-forest-hair", name: { en: "Seoul Forest Hair Clinic", ko: "서울숲 모발센터" }, city: { en: "Seongdong-gu, Seoul", ko: "서울 성동구" }, square: "https://images.unsplash.com/photo-1559599101-f09722fb4948?w=1000&q=80" },
    name: { en: "Scalp SMP", ko: "두피 문신(SMP)" },
    hero: "https://images.unsplash.com/photo-1559599101-f09722fb4948?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&q=80",
    summary: { en: "Non-surgical scalp micropigmentation for density.", ko: "두피 색소 착색으로 밀도감을 표현하는 비수술 시술." },
    duration: { en: "1 day + follow-up", ko: "당일 + 경과 검진" }, recovery: { en: "About 1 month", ko: "약 1개월" },
    includes: { en: ["Hair & scalp diagnosis","Procedure","Recovery care","Progress check-up"], ko: ["모발·두피 진단","시술","회복 케어","경과 검진"] },
    options: [{ group: { en: "Graft count", ko: "이식 모수" }, multi: false, pick: 1, items: { en: ["2,000 grafts","3,000 grafts"], ko: ["2,000모","3,000모"] } }],
    steps: { en: ["Diagnosis","Hairline design","Procedure","Progress check-up"], ko: ["진단","헤어라인 디자인","시술","경과 검진"] },
    prepare: { en: ["Guidance on trimming the treatment area"], ko: ["시술 부위 삭발 안내"] },
    listPrice: 2000000, price: 1500000,
  },
  {
    id: "hair-regen", category: "hair-loss", dept: { en: "Hair Restoration", ko: "모발이식" }, recoveryBand: "1m",
    hospital: { id: "seoul-forest-hair", name: { en: "Seoul Forest Hair Clinic", ko: "서울숲 모발센터" }, city: { en: "Seongdong-gu, Seoul", ko: "서울 성동구" }, square: "https://images.unsplash.com/photo-1559599101-f09722fb4948?w=1000&q=80" },
    name: { en: "Hair Regeneration", ko: "모발 재생 치료" },
    hero: "https://images.unsplash.com/photo-1559599101-f09722fb4948?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&q=80",
    summary: { en: "Combined injection and low-level laser hair therapy.", ko: "재생 주사·저출력 레이저 복합 탈모 치료." },
    duration: { en: "1 day + follow-up", ko: "당일 + 경과 검진" }, recovery: { en: "About 1 month", ko: "약 1개월" },
    includes: { en: ["Hair & scalp diagnosis","Procedure","Recovery care","Progress check-up"], ko: ["모발·두피 진단","시술","회복 케어","경과 검진"] },
    options: [{ group: { en: "Graft count", ko: "이식 모수" }, multi: false, pick: 1, items: { en: ["2,000 grafts","3,000 grafts"], ko: ["2,000모","3,000모"] } }],
    steps: { en: ["Diagnosis","Hairline design","Procedure","Progress check-up"], ko: ["진단","헤어라인 디자인","시술","경과 검진"] },
    prepare: { en: ["Guidance on trimming the treatment area"], ko: ["시술 부위 삭발 안내"] },
    listPrice: 1200000, price: 900000,
  },
  {
    id: "samsung-premium-checkup", category: "checkup", dept: { en: "Health Check-up", ko: "건강검진" }, recoveryBand: "lt1w",
    hospital: { id: "samsung-mc", name: { en: "Samsung Medical Center", ko: "삼성서울병원" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1581595219315-a187dd40c322?w=1000&q=80" },
    name: { en: "Premium Check-up", ko: "프리미엄 종합검진" },
    hero: "https://images.unsplash.com/photo-1581595219315-a187dd40c322?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&q=80",
    summary: { en: "Premium check-up spanning blood, imaging and endoscopy.", ko: "혈액·영상·내시경을 아우르는 프리미엄 종합 건강검진." },
    duration: { en: "Half-day", ko: "반나절" }, recovery: { en: "Same day", ko: "당일" },
    includes: { en: ["Consultation & basic measurements","Blood & urine panel","Imaging (ultrasound/CT)","Specialist result review"], ko: ["문진·기본 신체 계측","혈액·소변 정밀 검사","영상 검사(초음파/CT)","전문의 결과 상담"] },
    options: [{ group: { en: "Add-on tests", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Cardiac CT","Endoscopy (gastro/colon)","Tumor markers"], ko: ["심장 CT","위·대장 내시경","종양표지자 검사"] } }],
    steps: { en: ["Check-in & intake","Screening tests","Radiology reading","Result consultation"], ko: ["접수·문진","검사 진행","영상 판독","결과 상담"] },
    prepare: { en: ["Fast for 8 hours before the exam","Wear comfortable clothing"], ko: ["검사 전 8시간 금식","편안한 복장 착용"] },
    listPrice: 3800000, price: 3200000,
  },
  {
    id: "samsung-cardio", category: "checkup", dept: { en: "Health Check-up", ko: "건강검진" }, recoveryBand: "lt1w",
    hospital: { id: "samsung-mc", name: { en: "Samsung Medical Center", ko: "삼성서울병원" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1581595219315-a187dd40c322?w=1000&q=80" },
    name: { en: "Cardiovascular Screening", ko: "심혈관 정밀검진" },
    hero: "https://images.unsplash.com/photo-1581595219315-a187dd40c322?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&q=80",
    summary: { en: "Coronary CT and echocardiography-focused cardiac screening.", ko: "관상동맥 CT·심장 초음파 중심의 심혈관 정밀 검진." },
    duration: { en: "Half-day", ko: "반나절" }, recovery: { en: "Same day", ko: "당일" },
    includes: { en: ["Consultation & basic measurements","Blood & urine panel","Imaging (ultrasound/CT)","Specialist result review"], ko: ["문진·기본 신체 계측","혈액·소변 정밀 검사","영상 검사(초음파/CT)","전문의 결과 상담"] },
    options: [{ group: { en: "Add-on tests", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Cardiac CT","Endoscopy (gastro/colon)","Tumor markers"], ko: ["심장 CT","위·대장 내시경","종양표지자 검사"] } }],
    steps: { en: ["Check-in & intake","Screening tests","Radiology reading","Result consultation"], ko: ["접수·문진","검사 진행","영상 판독","결과 상담"] },
  ...
  {
    id: "samsung-cataract", category: "ophthalmology", dept: { en: "Ophthalmology", ko: "안과" }, recoveryBand: "lt1w",
    hospital: { id: "samsung-mc", name: { en: "Samsung Medical Center", ko: "삼성서울병원" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1581595219315-a187dd40c322?w=1000&q=80" },
    name: { en: "Cataract & Presbyopia Surgery", ko: "백내장·노안 수술" },
    hero: "https://images.unsplash.com/photo-1577003833619-76bbd7f82948?w=1200&q=80", before: "https://images.unsplash.com/photo-1645066928295-2506defde470?w=600&q=80", after: "https://images.unsplash.com/photo-1642975967602-653d378f3b5b?w=600&q=80",
    summary: { en: "Premium multifocal IOL cataract surgery.", ko: "프리미엄 다초점 인공수정체 백내장 수술." },
    duration: { en: "1–2 days in Korea", ko: "한국 체류 1–2일" }, recovery: { en: "48h recovery", ko: "48시간 회복" },
    includes: { en: ["Detailed pre-op eye exam","Procedure (both eyes)","Protective eyewear kit","Next-day check-up"], ko: ["수술 전 정밀 검사","시술(양안)","보호 안경 키트","익일 경과 검진"] },
    options: [{ group: { en: "Add-on examination", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Dry-eye screening","Corneal topography"], ko: ["안구건조 검사","각막 지형도 검사"] } }],
    steps: { en: ["Detailed pre-op exam","Surgeon consultation","Procedure","Same-day discharge","Next-day check-up"], ko: ["정밀 사전 검사","집도의 상담","시술","당일 퇴원","익일 경과 검진"] },
    prepare: { en: ["Stop wearing contact lenses 1 week prior","Arrange someone to accompany you home"], ko: ["1주 전부터 콘택트렌즈 착용 중단","귀가 시 동반자 준비"] },
    listPrice: 4500000, price: 3800000,
  },
  {
    id: "asan-endoscopy", category: "checkup", dept: { en: "Health Check-up", ko: "건강검진" }, recoveryBand: "lt1w",
    hospital: { id: "asan-mc", name: { en: "Asan Medical Center", ko: "서울아산병원" }, city: { en: "Songpa-gu, Seoul", ko: "서울 송파구" }, square: "https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=800&q=80" },
    name: { en: "GI Endoscopy Screening", ko: "소화기 내시경 검진" },
    hero: "https://images.unsplash.com/photo-1581595219315-a187dd40c322?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&q=80",
    summary: { en: "Sedated gastroscopy and colonoscopy package.", ko: "위·대장 내시경 수면 검진 패키지." },
    duration: { en: "Half-day", ko: "반나절" }, recovery: { en: "Same day", ko: "당일" },
    includes: { en: ["Consultation & basic measurements","Blood & urine panel","Imaging (ultrasound/CT)","Specialist result review"], ko: ["문진·기본 신체 계측","혈액·소변 정밀 검사","영상 검사(초음파/CT)","전문의 결과 상담"] },
    options: [{ group: { en: "Add-on tests", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Cardiac CT","Endoscopy (gastro/colon)","Tumor markers"], ko: ["심장 CT","위·대장 내시경","종양표지자 검사"] } }],
    steps: { en: ["Check-in & intake","Screening tests","Radiology reading","Result consultation"], ko: ["접수·문진","검사 진행","영상 판독","결과 상담"] },
    prepare: { en: ["Fast for 8 hours before the exam","Wear comfortable clothing"], ko: ["검사 전 8시간 금식","편안한 복장 착용"] },
    listPrice: 1600000, price: 1300000,
  },
  {
    id: "asan-premium-checkup", category: "checkup", dept: { en: "Health Check-up", ko: "건강검진" }, recoveryBand: "lt1w",
    hospital: { id: "asan-mc", name: { en: "Asan Medical Center", ko: "서울아산병원" }, city: { en: "Songpa-gu, Seoul", ko: "서울 송파구" }, square: "https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=800&q=80" },
    name: { en: "Premium Check-up", ko: "프리미엄 종합검진" },
    hero: "https://images.unsplash.com/photo-1581595219315-a187dd40c322?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&q=80",
    summary: { en: "Comprehensive check-up at a top tertiary hospital.", ko: "상급종합병원의 정밀 종합 건강검진." },
    duration: { en: "Half-day", ko: "반나절" }, recovery: { en: "Same day", ko: "당일" },
    includes: { en: ["Consultation & basic measurements","Blood & urine panel","Imaging (ultrasound/CT)","Specialist result review"], ko: ["문진·기본 신체 계측","혈액·소변 정밀 검사","영상 검사(초음파/CT)","전문의 결과 상담"] },
    options: [{ group: { en: "Add-on tests", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Cardiac CT","Endoscopy (gastro/colon)","Tumor markers"], ko: ["심장 CT","위·대장 내시경","종양표지자 검사"] } }],
    steps: { en: ["Check-in & intake","Screening tests","Radiology reading","Result consultation"], ko: ["접수·문진","검사 진행","영상 판독","결과 상담"] },
    prepare: { en: ["Fast for 8 hours before the exam","Wear comfortable clothing"], ko: ["검사 전 8시간 금식","편안한 복장 착용"] },
    listPrice: 3600000, price: 3000000,
  },
  {
    id: "asan-arthroscopy", category: "orthopedics", dept: { en: "Orthopedics", ko: "정형외과" }, recoveryBand: "1-2w",
    hospital: { id: "asan-mc", name: { en: "Asan Medical Center", ko: "서울아산병원" }, city: { en: "Songpa-gu, Seoul", ko: "서울 송파구" }, square: "https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=800&q=80" },
    name: { en: "Joint Arthroscopy", ko: "관절 내시경 시술" },
    hero: "https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1551076805-e1869033e561?w=600&q=80",
    summary: { en: "Minimally-invasive knee/shoulder arthroscopy.", ko: "무릎·어깨 관절 내시경 최소 침습 시술." },
    duration: { en: "1 day + rehab", ko: "당일 + 재활" }, recovery: { en: "1–2 weeks", ko: "1–2주" },
    includes: { en: ["Detailed imaging (MRI/X-ray)","Procedure","Rehabilitation guidance","Progress check-up"], ko: ["정밀 영상 검사(MRI/X-ray)","시술","재활 안내","경과 검진"] },
    options: [{ group: { en: "Add-on tests", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["MRI","Bone density"], ko: ["MRI","골밀도 검사"] } }],
    steps: { en: ["Diagnosis","Consultation","Procedure","Rehabilitation"], ko: ["진단","상담","시술","재활"] },
    prepare: { en: ["Bring prior imaging if available"], ko: ["기존 영상 자료 지참(있을 경우)"] },
    listPrice: 5500000, price: 4600000,
  },
  {
    id: "severance-lasik", category: "ophthalmology", dept: { en: "Ophthalmology", ko: "안과" }, recoveryBand: "lt1w",
    hospital: { id: "severance", name: { en: "Severance Hospital (Yonsei)", ko: "연세세브란스병원" }, city: { en: "Seodaemun-gu, Seoul", ko: "서울 서대문구" }, square: "https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=800&q=80" },
    name: { en: "Robotic LASIK", ko: "로봇 시력교정 라식" },
    hero: "https://images.unsplash.com/photo-1577003833619-76bbd7f82948?w=1200&q=80", before: "https://images.unsplash.com/photo-1645066928295-2506defde470?w=600&q=80", after: "https://images.unsplash.com/photo-1642975967602-653d378f3b5b?w=600&q=80",
    summary: { en: "Robot-assisted precision LASIK vision correction.", ko: "로봇 보조 정밀 라식 시력교정." },
    duration: { en: "1–2 days in Korea", ko: "한국 체류 1–2일" }, recovery: { en: "48h recovery", ko: "48시간 회복" },
    includes: { en: ["Detailed pre-op eye exam","Procedure (both eyes)","Protective eyewear kit","Next-day check-up"], ko: ["수술 전 정밀 검사","시술(양안)","보호 안경 키트","익일 경과 검진"] },
    options: [{ group: { en: "Add-on examination", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Dry-eye screening","Corneal topography"], ko: ["안구건조 검사","각막 지형도 검사"] } }],
    steps: { en: ["Detailed pre-op exam","Surgeon consultation","Procedure","Same-day discharge","Next-day check-up"], ko: ["정밀 사전 검사","집도의 상담","시술","당일 퇴원","익일 경과 검진"] },
    prepare: { en: ["Stop wearing contact lenses 1 week prior","Arrange someone to accompany you home"], ko: ["1주 전부터 콘택트렌즈 착용 중단","귀가 시 동반자 준비"] },
    listPrice: 2400000, price: 2000000,
  },
  {
    id: "severance-women-checkup", category: "checkup", dept: { en: "Health Check-up", ko: "건강검진" }, recoveryBand: "lt1w",
    hospital: { id: "severance", name: { en: "Severance Hospital (Yonsei)", ko: "연세세브란스병원" }, city: { en: "Seodaemun-gu, Seoul", ko: "서울 서대문구" }, square: "https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=800&q=80" },
    name: { en: "Women's Check-up", ko: "여성 종합검진" },
    hero: "https://images.unsplash.com/photo-1581595219315-a187dd40c322?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&q=80",
    summary: { en: "Women's check-up specialized in breast and OB/GYN.", ko: "유방·부인과 특화 여성 종합 건강검진." },
    duration: { en: "Half-day", ko: "반나절" }, recovery: { en: "Same day", ko: "당일" },
    includes: { en: ["Consultation & basic measurements","Blood & urine panel","Imaging (ultrasound/CT)","Specialist result review"], ko: ["문진·기본 신체 계측","혈액·소변 정밀 검사","영상 검사(초음파/CT)","전문의 결과 상담"] },
    options: [{ group: { en: "Add-on tests", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Cardiac CT","Endoscopy (gastro/colon)","Tumor markers"], ko: ["심장 CT","위·대장 내시경","종양표지자 검사"] } }],
    steps: { en: ["Check-in & intake","Screening tests","Radiology reading","Result consultation"], ko: ["접수·문진","검사 진행","영상 판독","결과 상담"] },
    prepare: { en: ["Fast for 8 hours before the exam","Wear comfortable clothing"], ko: ["검사 전 8시간 금식","편안한 복장 착용"] },
    listPrice: 2200000, price: 1800000,
  },
  {
    id: "severance-spine", category: "orthopedics", dept: { en: "Orthopedics", ko: "정형외과" }, recoveryBand: "1-2w",
    hospital: { id: "severance", name: { en: "Severance Hospital (Yonsei)", ko: "연세세브란스병원" }, city: { en: "Seodaemun-gu, Seoul", ko: "서울 서대문구" }, square: "https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=800&q=80" },
    name: { en: "Spine Procedure", ko: "척추 시술" },
    hero: "https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1551076805-e1869033e561?w=600&q=80",
    summary: { en: "Non-surgical, minimally-invasive spine pain procedure.", ko: "비수술·최소 침습 척추 통증 시술." },
    duration: { en: "1 day + rehab", ko: "당일 + 재활" }, recovery: { en: "1–2 weeks", ko: "1–2주" },
    includes: { en: ["Detailed imaging (MRI/X-ray)","Procedure","Rehabilitation guidance","Progress check-up"], ko: ["정밀 영상 검사(MRI/X-ray)","시술","재활 안내","경과 검진"] },
    options: [{ group: { en: "Add-on tests", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["MRI","Bone density"], ko: ["MRI","골밀도 검사"] } }],
    steps: { en: ["Diagnosis","Consultation","Procedure","Rehabilitation"], ko: ["진단","상담","시술","재활"] },
    prepare: { en: ["Bring prior imaging if available"], ko: ["기존 영상 자료 지참(있을 경우)"] },
    listPrice: 4800000, price: 4000000,
  },
  {
    id: "marys-checkup", category: "checkup", dept: { en: "Health Check-up", ko: "건강검진" }, recoveryBand: "lt1w",
    hospital: { id: "seoul-saint-marys", name: { en: "Seoul St. Mary's Hospital", ko: "서울성모병원" }, city: { en: "Seocho-gu, Seoul", ko: "서울 서초구" }, square: "https://images.unsplash.com/photo-1516069677018-378515003435?w=800&q=80" },
    name: { en: "Comprehensive Check-up", ko: "종합 건강검진" },
    hero: "https://images.unsplash.com/photo-1581595219315-a187dd40c322?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&q=80",
    summary: { en: "Comprehensive check-up focused on core organs.", ko: "핵심 장기 중심의 종합 건강검진." },
    duration: { en: "Half-day", ko: "반나절" }, recovery: { en: "Same day", ko: "당일" },
    includes: { en: ["Consultation & basic measurements","Blood & urine panel","Imaging (ultrasound/CT)","Specialist result review"], ko: ["문진·기본 신체 계측","혈액·소변 정밀 검사","영상 검사(초음파/CT)","전문의 결과 상담"] },
    options: [{ group: { en: "Add-on tests", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Cardiac CT","Endoscopy (gastro/colon)","Tumor markers"], ko: ["심장 CT","위·대장 내시경","종양표지자 검사"] } }],
    steps: { en: ["Check-in & intake","Screening tests","Radiology reading","Result consultation"], ko: ["접수·문진","검사 진행","영상 판독","결과 상담"] },
    prepare: { en: ["Fast for 8 hours before the exam","Wear comfortable clothing"], ko: ["검사 전 8시간 금식","편안한 복장 착용"] },
    listPrice: 1900000, price: 1600000,
  },
  {
    id: "marys-cataract", category: "ophthalmology", dept: { en: "Ophthalmology", ko: "안과" }, recoveryBand: "lt1w",
    hospital: { id: "seoul-saint-marys", name: { en: "Seoul St. Mary's Hospital", ko: "서울성모병원" }, city: { en: "Seocho-gu, Seoul", ko: "서울 서초구" }, square: "https://images.unsplash.com/photo-1516069677018-378515003435?w=800&q=80" },
    name: { en: "Cataract Surgery", ko: "백내장 수술" },
    hero: "https://images.unsplash.com/photo-1577003833619-76bbd7f82948?w=1200&q=80", before: "https://images.unsplash.com/photo-1645066928295-2506defde470?w=600&q=80", after: "https://images.unsplash.com/photo-1642975967602-653d378f3b5b?w=600&q=80",
    summary: { en: "Standard IOL cataract surgery.", ko: "표준 인공수정체 백내장 수술." },
    duration: { en: "1–2 days in Korea", ko: "한국 체류 1–2일" }, recovery: { en: "48h recovery", ko: "48시간 회복" },
    includes: { en: ["Detailed pre-op eye exam","Procedure (both eyes)","Protective eyewear kit","Next-day check-up"], ko: ["수술 전 정밀 검사","시술(양안)","보호 안경 키트","익일 경과 검진"] },
    options: [{ group: { en: "Add-on examination", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Dry-eye screening","Corneal topography"], ko: ["안구건조 검사","각막 지형도 검사"] } }],
    steps: { en: ["Detailed pre-op exam","Surgeon consultation","Procedure","Same-day discharge","Next-day check-up"], ko: ["정밀 사전 검사","집도의 상담","시술","당일 퇴원","익일 경과 검진"] },
    prepare: { en: ["Stop wearing contact lenses 1 week prior","Arrange someone to accompany you home"], ko: ["1주 전부터 콘택트렌즈 착용 중단","귀가 시 동반자 준비"] },
    listPrice: 3000000, price: 2500000,
  },
  {
    id: "marys-knee", category: "orthopedics", dept: { en: "Orthopedics", ko: "정형외과" }, recoveryBand: "1-2w",
    hospital: { id: "seoul-saint-marys", name: { en: "Seoul St. Mary's Hospital", ko: "서울성모병원" }, city: { en: "Seocho-gu, Seoul", ko: "서울 서초구" }, square: "https://images.unsplash.com/photo-1516069677018-378515003435?w=800&q=80" },
    name: { en: "Knee Joint Procedure", ko: "무릎 관절 시술" },
    hero: "https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1551076805-e1869033e561?w=600&q=80",
    summary: { en: "Minimally-invasive procedure for degenerative knees.", ko: "퇴행성 무릎 관절 최소 침습 시술." },
    duration: { en: "1 day + rehab", ko: "당일 + 재활" }, recovery: { en: "1–2 weeks", ko: "1–2주" },
    includes: { en: ["Detailed imaging (MRI/X-ray)","Procedure","Rehabilitation guidance","Progress check-up"], ko: ["정밀 영상 검사(MRI/X-ray)","시술","재활 안내","경과 검진"] },
    options: [{ group: { en: "Add-on tests", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["MRI","Bone density"], ko: ["MRI","골밀도 검사"] } }],
    steps: { en: ["Diagnosis","Consultation","Procedure","Rehabilitation"], ko: ["진단","상담","시술","재활"] },
    prepare: { en: ["Bring prior imaging if available"], ko: ["기존 영상 자료 지참(있을 경우)"] },
    listPrice: 5200000, price: 4400000,
  },
  {
    id: "jk-facial-contour", category: "plastic", dept: { en: "Plastic Surgery", ko: "성형외과" }, recoveryBand: "1m",
    hospital: { id: "jk-plastic", name: { en: "JK Plastic Surgery Center", ko: "JK성형외과" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1622902046580-2b47f47f5471?w=800&q=80" },
    name: { en: "Facial Contouring", ko: "안면윤곽" },
    hero: "https://images.unsplash.com/photo-1622902046580-2b47f47f5471?w=1200&q=80", before: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=600&q=80", after: "https://images.unsplash.com/photo-1516549655169-df83a0774514?w=600&q=80",
    summary: { en: "Precision surgery for facial asymmetry and contour.", ko: "안면 비대칭·윤곽을 개선하는 정밀 수술." },
    duration: { en: "1 day + follow-up", ko: "당일 + 경과 검진" }, recovery: { en: "2–4 weeks", ko: "2–4주" },
    includes: { en: ["Consultation & design","Surgery","Recovery care","Progress check-up"], ko: ["상담·디자인","수술","회복 관리","경과 검진"] },
    options: [{ group: { en: "Add-on", ko: "추가 옵션" }, multi: true, pick: 1, items: { en: ["Scar care","Swelling management"], ko: ["흉터 케어","붓기 관리"] } }],
    steps: { en: ["Consultation","Design","Surgery","Recovery care"], ko: ["상담","디자인","수술","회복 관리"] },
    prepare: { en: ["Blood test before surgery","Stop smoking 2 weeks prior"], ko: ["수술 전 혈액검사","2주 전 금연"] },
    listPrice: 9000000, price: 7500000,
  },
  {
    id: "jk-rhinoplasty", category: "plastic", dept: { en: "Plastic Surgery", ko: "성형외과" }, recoveryBand: "1m",
    hospital: { id: "jk-plastic", name: { en: "JK Plastic Surgery Center", ko: "JK성형외과" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1622902046580-2b47f47f5471?w=800&q=80" },
    name: { en: "Rhinoplasty", ko: "코 성형" },
    hero: "https://images.unsplash.com/photo-1622902046580-2b47f47f5471?w=1200&q=80", before: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=600&q=80", after: "https://images.unsplash.com/photo-1516549655169-df83a0774514?w=600&q=80",
    summary: { en: "Rhinoplasty balancing function and aesthetics.", ko: "기능·미용을 함께 고려한 코 성형." },
    duration: { en: "1 day + follow-up", ko: "당일 + 경과 검진" }, recovery: { en: "2–4 weeks", ko: "2–4주" },
    includes: { en: ["Consultation & design","Surgery","Recovery care","Progress check-up"], ko: ["상담·디자인","수술","회복 관리","경과 검진"] },
    options: [{ group: { en: "Add-on", ko: "추가 옵션" }, multi: true, pick: 1, items: { en: ["Scar care","Swelling management"], ko: ["흉터 케어","붓기 관리"] } }],
    steps: { en: ["Consultation","Design","Surgery","Recovery care"], ko: ["상담","디자인","수술","회복 관리"] },
    prepare: { en: ["Blood test before surgery","Stop smoking 2 weeks prior"], ko: ["수술 전 혈액검사","2주 전 금연"] },
    listPrice: 6000000, price: 5000000,
  },
  {
    id: "jk-eyelid", category: "plastic", dept: { en: "Plastic Surgery", ko: "성형외과" }, recoveryBand: "1m",
    hospital: { id: "jk-plastic", name: { en: "JK Plastic Surgery Center", ko: "JK성형외과" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1622902046580-2b47f47f5471?w=800&q=80" },
    name: { en: "Eyelid Surgery", ko: "눈 성형" },
    hero: "https://images.unsplash.com/photo-1622902046580-2b47f47f5471?w=1200&q=80", before: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=600&q=80", after: "https://images.unsplash.com/photo-1516549655169-df83a0774514?w=600&q=80",
    summary: { en: "Eyelid surgery for a natural eye line.", ko: "자연스러운 라인의 눈매 교정." },
    duration: { en: "1 day + follow-up", ko: "당일 + 경과 검진" }, recovery: { en: "2–4 weeks", ko: "2–4주" },
    includes: { en: ["Consultation & design","Surgery","Recovery care","Progress check-up"], ko: ["상담·디자인","수술","회복 관리","경과 검진"] },
    options: [{ group: { en: "Add-on", ko: "추가 옵션" }, multi: true, pick: 1, items: { en: ["Scar care","Swelling management"], ko: ["흉터 케어","붓기 관리"] } }],
    steps: { en: ["Consultation","Design","Surgery","Recovery care"], ko: ["상담","디자인","수술","회복 관리"] },
    prepare: { en: ["Blood test before surgery","Stop smoking 2 weeks prior"], ko: ["수술 전 혈액검사","2주 전 금연"] },
    listPrice: 3500000, price: 2900000,
  },
  {
    id: "oracle-implant", category: "dental", dept: { en: "Dental", ko: "치과" }, recoveryBand: "1m",
    hospital: { id: "oracle-dental", name: { en: "Oracle Dental Clinic (Gangnam)", ko: "오라클치과 (강남)" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=800&q=80" },
    name: { en: "Dental Implant", ko: "임플란트" },
    hero: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=1200&q=80", before: "https://images.unsplash.com/photo-1609840114035-3c981b782dfe?w=600&q=80", after: "https://images.unsplash.com/photo-1581585095544-bb2c8a4d3a3e?w=600&q=80",
    summary: { en: "Digitally-guided dental implant placement.", ko: "디지털 가이드 임플란트 식립." },
    duration: { en: "2 visits over 3 months", ko: "3개월간 2회 방문" }, recovery: { en: "About 1 month", ko: "약 1개월" },
    includes: { en: ["3D CT imaging & planning","Procedure","Crown / prosthesis","Post-care scaling"], ko: ["3D CT 촬영·계획","시술","크라운·보철","사후 스케일링"] },
    options: [{ group: { en: "Material", ko: "재질" }, multi: false, pick: 1, items: { en: ["Zirconia","Gold"], ko: ["지르코니아","골드"] } }],
    steps: { en: ["Diagnosis & imaging","Consultation","Procedure","Post-care follow-up"], ko: ["진단·촬영","상담","시술","사후 관리"] },
    prepare: { en: ["Bring previous dental records if available"], ko: ["기존 치과 진료 기록 지참(있을 경우)"] },
    listPrice: 2000000, price: 1600000,
  },
  {
    id: "oracle-veneer", category: "dental", dept: { en: "Dental", ko: "치과" }, recoveryBand: "1m",
    hospital: { id: "oracle-dental", name: { en: "Oracle Dental Clinic (Gangnam)", ko: "오라클치과 (강남)" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=800&q=80" },
    name: { en: "Ceramic Veneer", ko: "세라믹 라미네이트" },
    hero: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=1200&q=80", before: "https://images.unsplash.com/photo-1609840114035-3c981b782dfe?w=600&q=80", after: "https://images.unsplash.com/photo-1581585095544-bb2c8a4d3a3e?w=600&q=80",
    summary: { en: "Natural-looking ceramic veneers.", ko: "자연스러운 세라믹 라미네이트." },
    duration: { en: "2 visits over 3 months", ko: "3개월간 2회 방문" }, recovery: { en: "About 1 month", ko: "약 1개월" },
    includes: { en: ["3D CT imaging & planning","Procedure","Crown / prosthesis","Post-care scaling"], ko: ["3D CT 촬영·계획","시술","크라운·보철","사후 스케일링"] },
    options: [{ group: { en: "Material", ko: "재질" }, multi: false, pick: 1, items: { en: ["Zirconia","Gold"], ko: ["지르코니아","골드"] } }],
    steps: { en: ["Diagnosis & imaging","Consultation","Procedure","Post-care follow-up"], ko: ["진단·촬영","상담","시술","사후 관리"] },
  ...
  {
    id: "oracle-aligner", category: "dental", dept: { en: "Dental", ko: "치과" }, recoveryBand: "1m",
    hospital: { id: "oracle-dental", name: { en: "Oracle Dental Clinic (Gangnam)", ko: "오라클치과 (강남)" }, city: { en: "Gangnam-gu, Seoul", ko: "서울 강남구" }, square: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=800&q=80" },
    name: { en: "Clear Aligner", ko: "투명교정" },
    hero: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=1200&q=80", before: "https://images.unsplash.com/photo-1609840114035-3c981b782dfe?w=600&q=80", after: "https://images.unsplash.com/photo-1581585095544-bb2c8a4d3a3e?w=600&q=80",
    summary: { en: "Tooth alignment with clear aligners.", ko: "투명 장치를 이용한 치아 교정." },
    duration: { en: "2 visits over 3 months", ko: "3개월간 2회 방문" }, recovery: { en: "About 1 month", ko: "약 1개월" },
    includes: { en: ["3D CT imaging & planning","Procedure","Crown / prosthesis","Post-care scaling"], ko: ["3D CT 촬영·계획","시술","크라운·보철","사후 스케일링"] },
    options: [{ group: { en: "Material", ko: "재질" }, multi: false, pick: 1, items: { en: ["Zirconia","Gold"], ko: ["지르코니아","골드"] } }],
    steps: { en: ["Diagnosis & imaging","Consultation","Procedure","Post-care follow-up"], ko: ["진단·촬영","상담","시술","사후 관리"] },
    prepare: { en: ["Bring previous dental records if available"], ko: ["기존 치과 진료 기록 지참(있을 경우)"] },
    listPrice: 5800000, price: 4600000,
  },
  {
    id: "snuh-checkup", category: "checkup", dept: { en: "Health Check-up", ko: "건강검진" }, recoveryBand: "lt1w",
    hospital: { id: "snuh", name: { en: "Seoul National University Hospital", ko: "서울대학교병원" }, city: { en: "Jongno-gu, Seoul", ko: "서울 종로구" }, square: "https://images.unsplash.com/photo-1579154204601-01588f351e67?w=800&q=80" },
    name: { en: "Premium Check-up", ko: "프리미엄 종합검진" },
    hero: "https://images.unsplash.com/photo-1581595219315-a187dd40c322?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&q=80",
    summary: { en: "Precision comprehensive check-up at a national hospital.", ko: "중앙병원급 정밀 종합 건강검진." },
    duration: { en: "Half-day", ko: "반나절" }, recovery: { en: "Same day", ko: "당일" },
    includes: { en: ["Consultation & basic measurements","Blood & urine panel","Imaging (ultrasound/CT)","Specialist result review"], ko: ["문진·기본 신체 계측","혈액·소변 정밀 검사","영상 검사(초음파/CT)","전문의 결과 상담"] },
    options: [{ group: { en: "Add-on tests", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Cardiac CT","Endoscopy (gastro/colon)","Tumor markers"], ko: ["심장 CT","위·대장 내시경","종양표지자 검사"] } }],
    steps: { en: ["Check-in & intake","Screening tests","Radiology reading","Result consultation"], ko: ["접수·문진","검사 진행","영상 판독","결과 상담"] },
    prepare: { en: ["Fast for 8 hours before the exam","Wear comfortable clothing"], ko: ["검사 전 8시간 금식","편안한 복장 착용"] },
    listPrice: 3400000, price: 2900000,
  },
  {
    id: "snuh-cataract", category: "ophthalmology", dept: { en: "Ophthalmology", ko: "안과" }, recoveryBand: "lt1w",
    hospital: { id: "snuh", name: { en: "Seoul National University Hospital", ko: "서울대학교병원" }, city: { en: "Jongno-gu, Seoul", ko: "서울 종로구" }, square: "https://images.unsplash.com/photo-1579154204601-01588f351e67?w=800&q=80" },
    name: { en: "Cataract Surgery", ko: "백내장 수술" },
    hero: "https://images.unsplash.com/photo-1577003833619-76bbd7f82948?w=1200&q=80", before: "https://images.unsplash.com/photo-1645066928295-2506defde470?w=600&q=80", after: "https://images.unsplash.com/photo-1642975967602-653d378f3b5b?w=600&q=80",
    summary: { en: "IOL cataract surgery.", ko: "백내장 인공수정체 수술." },
    duration: { en: "1–2 days in Korea", ko: "한국 체류 1–2일" }, recovery: { en: "48h recovery", ko: "48시간 회복" },
    includes: { en: ["Detailed pre-op eye exam","Procedure (both eyes)","Protective eyewear kit","Next-day check-up"], ko: ["수술 전 정밀 검사","시술(양안)","보호 안경 키트","익일 경과 검진"] },
    options: [{ group: { en: "Add-on examination", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["Dry-eye screening","Corneal topography"], ko: ["안구건조 검사","각막 지형도 검사"] } }],
    steps: { en: ["Detailed pre-op exam","Surgeon consultation","Procedure","Same-day discharge","Next-day check-up"], ko: ["정밀 사전 검사","집도의 상담","시술","당일 퇴원","익일 경과 검진"] },
  ...
  {
    id: "snuh-spine-joint", category: "orthopedics", dept: { en: "Orthopedics", ko: "정형외과" }, recoveryBand: "1-2w",
    hospital: { id: "snuh", name: { en: "Seoul National University Hospital", ko: "서울대학교병원" }, city: { en: "Jongno-gu, Seoul", ko: "서울 종로구" }, square: "https://images.unsplash.com/photo-1579154204601-01588f351e67?w=800&q=80" },
    name: { en: "Spine & Joint Procedure", ko: "척추·관절 시술" },
    hero: "https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=1200&q=80", before: "https://images.unsplash.com/photo-1516069677018-378515003435?w=600&q=80", after: "https://images.unsplash.com/photo-1551076805-e1869033e561?w=600&q=80",
    summary: { en: "Minimally-invasive spine and joint pain procedure.", ko: "척추·관절 통증 최소 침습 시술." },
    duration: { en: "1 day + rehab", ko: "당일 + 재활" }, recovery: { en: "1–2 weeks", ko: "1–2주" },
    includes: { en: ["Detailed imaging (MRI/X-ray)","Procedure","Rehabilitation guidance","Progress check-up"], ko: ["정밀 영상 검사(MRI/X-ray)","시술","재활 안내","경과 검진"] },
    options: [{ group: { en: "Add-on tests", ko: "추가 검사" }, multi: true, pick: 1, items: { en: ["MRI","Bone density"], ko: ["MRI","골밀도 검사"] } }],
    steps: { en: ["Diagnosis","Consultation","Procedure","Rehabilitation"], ko: ["진단","상담","시술","재활"] },
    prepare: { en: ["Bring prior imaging if available"], ko: ["기존 영상 자료 지참(있을 경우)"] },
    listPrice: 5000000, price: 4200000,
  },
];
